...
from cherrypy_local.lib.reprconf import attributes
from cherrypy_local._cpcompat import text_or_bytes
from cherrypy_local.process.servers import ServerAdapter
...
class Server(ServerAdapter):
    ...
    * X_REMOTE_GROUP
    ...
    def httpserver_from_self(self, httpserver=None):
        ...
        if httpserver is None:
            from cherrypy_local import _cpwsgi_server
