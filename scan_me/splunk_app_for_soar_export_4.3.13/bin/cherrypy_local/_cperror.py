...
send an e-mail containing the error::
    ...
    from cherrypy_local import _cperror
...
from cherrypy_local._cpcompat import escape_html
from cherrypy_local._cpcompat import ntob
from cherrypy_local._cpcompat import tonative
from cherrypy_local._helper import classproperty
from cherrypy_local.lib import httputil as _httputil
        ...
        try:
            if hasattr(error_page, '__call__'):
                ...
                if cherrypy.lib.is_iterator(result):
                    from cherrypy_local.lib.encoding import UTF8StreamEncoder
