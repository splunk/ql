...
import six.moves.urllib.request as six

import cherrypy_local as cherrypy
from cherrypy_local._cpcompat import ntob, tonative
...
class HttpDigestAuthorization(object):
    ...
    def __init__(
        ...
        items = six.parse_http_list(params)
        paramsd = six.parse_keqv_list(items)
