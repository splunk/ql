...
define(['require', 'jquery', 'underscore', 'backbone', 'splunkjs/mvc/utils', 'util/splunkd_utils'], function (require, exports, module) {
    ...
    exports.Model = Backbone.Model.extend(
        /** @lends module:kvstore~Model.prototype */
        {
             ...
             * @method see {@link http://backbonejs.org/#Model-save|Backbone.Model.prototype.save}
             * @param [key]     {(string|object)} As object used as key/value set; as string uses "value" for {key: value}
             * @param [value]   {(string|object)} only used if Key param is type string, passed os {key: value}
             ...
             *
             */
            save:  function({key = null, value = null, options = null} = {}) {
                if (this.id === '') {
                ...
                if (this._isNew) {
                    ...
                    options.success = function() {
                        model.isNew(false);
                        if (success) {
                            success.apply(this, arguments); // n.b. applying "this" on arrow functions has no effect.
                        }
                    };
                }
